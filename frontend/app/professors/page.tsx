                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <motion.button
                            ...
                            className={`text-white px-6 py-3 rounded-2xl font-semibold transition-all flex items-center justify-center gap-2 group ${dataSource === 'dummy' ? 'bg-slate-400 cursor-not-allowed opacity-50' : 'bg-indigo-600 hover:bg-indigo-500 shadow-xl shadow-indigo-500/25'}`}
                        >
                                ...
                                >
                                    <div className="flex justify-between items-start mb-6">
                                        ...
                                        <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button onClick={() => handleEdit(prof)} disabled={dataSource === 'dummy'} className={`p-2 rounded-xl transition-colors ${dataSource === 'dummy' ? "text-slate-300 cursor-not-allowed opacity-50" : "hover:bg-indigo-50 dark:hover:bg-indigo-900/30 text-indigo-500"}`}>
                                                <Edit size={18} />
                                            </button>
                                            <button onClick={() => handleDelete(prof.u_id)} disabled={dataSource === 'dummy'} className={`p-2 rounded-xl transition-colors ${dataSource === 'dummy' ? "text-slate-300 cursor-not-allowed opacity-50" : "hover:bg-red-50 dark:hover:bg-red-900/20 text-red-500"}`}>
                                                <Trash2 size={18} />
                                            </button>
                                        </div>
                                    </div>
