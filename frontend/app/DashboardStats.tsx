...
export default function DashboardStats() {
  ...
  const statsData = stats ? [
    ...
    { label: "Active Courses", value: stats.active_courses.toString(), icon: LayoutDashboard, color: "text-indigo-500", bg: "bg-indigo-500/10" },
    { label: "Scheduled Classes", value: stats.scheduled_classes.toString(), icon: Calendar, color: "text-emerald-500", bg: "bg-emerald-500/10" },
    { label: "Completion Rate", value: `${stats.completion_rate}%`, icon: TrendingUp, color: "text-amber-500", bg: "bg-amber-500/10" },
  ] : [];
